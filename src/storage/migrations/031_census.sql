-- T+ 轨：Census Data API Discovery 目录
...
CREATE TABLE IF NOT EXISTS census_catalog_datasets (
  ...
  PRIMARY KEY (dataset_path)
);

CREATE INDEX IF NOT EXISTS idx_census_catalog_tier ON census_catalog_datasets(tier) WHERE collect_enabled;
