-- T+ 轨：BEA API 目录（dataset → TableName）
...
CREATE TABLE IF NOT EXISTS bea_catalog_tables (
...
CREATE INDEX IF NOT EXISTS idx_bea_catalog_tier ON bea_catalog_tables(tier) WHERE collect_enabled;
