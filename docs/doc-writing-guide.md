...
复制后替换尖括号内容；**不要**在文内复制实施进度全文。（相对路径以 `docs/plans/` 为基准）

```markdown
# <专题名称>方案

> **状态**：设计草案  
> **进度真源**：[实施进度总览.md](./plans/实施进度总览.md) §<轨>/<编号>  
> **关联**：[design.md](./design.md) §<节> · [plans/<相关方案>.md](./plans/<相关方案>.md)  
> **文档地图** → [README.md](../README.md)
...
见 [实施进度总览 §2.x](./plans/实施进度总览.md#2-代码真源当前-head)（勿在此粘贴全表）。
