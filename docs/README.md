...
> **导航真源**（2026-09-07 修订）· 各文档职责互斥，避免重复维护同一段架构/进度叙述。
...
| 日期 | 说明 |
|------|------|
| 2026-09-07 | 文档修订同步：design.md v0.4（§零 0.3 去数字化）· overview.md v2.2 · 实施进度 §2 追平代码真源（48 id/40 cron/001–037/96 files·398）· CLAUDE.md 目录树与 CLI 重写 · AGENTS.md 引擎路径注记 |
